  ...
  constructor() {
    const countriesData = {
      ...
      english: [
        ...
        ["Cabo Verde", "cv", "238"],
        ["Bonaire, Saint Eustatius and Saba", "bq", "599", 1],
    ...
    if (localStorage.getItem("language") === "ar") {
      this.allCountries = countriesData.arabic;
    } else {
      this.allCountries = countriesData.english;
    }
  }
}
...
NgxIntlTelInputComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  ...
  viewQueries: [
    {
      propertyName: "countryList",
      first: true,
      predicate: ["countryList"],
      descendants: true,
    },
  ],
  usesOnChanges: true,
  ...
  directives: [
    { type: i2.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] },
    {
...
NgxIntlTelInputModule.ɵinj = i0.ɵɵngDeclareInjector({
  ...
  type: NgxIntlTelInputModule,
  imports: [
    [CommonModule, FormsModule, ReactiveFormsModule, dropdownModuleForRoot],
  ],
});
i0.ɵɵngDeclareClassMetadata({
  minVersion: "12.0.0",
